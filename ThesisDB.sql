...
1362	DISEÑO Y FORMULACIÓN DEL SUSBSISTEMA DE CONTROL ESTRATÉGICO DEL MODELO ESTANDAR DE CONTROL INTERNO MECI PARA EL HONORABLE CONCEJO MUNICIPAL DE LOS ANDES (NARIÑO)	2010	f	T	Auditoria,Otro	f
...
1399	SOFTWARE EDUCATIVO DE APOYO PARA LA PREPARACIÓN DE ESTUDIANTES DE QUINTO DE PRIMARIA EN LAS PRUEBAS SABER. CASO DE ESTUDIO:   LICEO INTEGRADO DE LA UNIVERSIDAD DE NARIÑO	2011	f	T	OVAS,Otro	t
...
22	SISTEMA ELECTRONICO DE ALERTA TEMPRANA POR VARIACION EXTREMA EN EL NIVEL DEL MAR COMO UNA CONTRUBUCION A LA DISMINUCION DE LA VULNERABILIDAD POR RIESGO DE TSUNAMI EN LAS POBLACIONES COSTERAS DEL LITORAL PACIFICO COLOMBIANO	2011	f	T	Aplicación De Escritorio,Otro	t
...
1370	4	2	Mixta	Educación	f	1 Meses	2017-10-18	Va dirigido a comunidad en general, una aplicación web que administra y procesa información de especialistas en ecología y geografía. Aplicación que cuenta con siete modulos.\r\n\r\nSe debe validar el tiempo de uso desde lanzamiento en producción, el costo de tiempo en desarrollo y la fecha de la ultima actualización. De la misma forma verificar si se encuentra en producción.	C#	Html,XML	SQL Server	.NET	ISS	1 Meses	0	JQuery
1282	7	1	Publica	Educación	f	1 Meses	2017-10-17	Uso de Enterprise Architect,  Framework .NET ODBC.\r\nTiempo de uso desde lanzamiento, fecha de ultima actualización y si esta actualmente en producción se deben validar en campo, al igual que el costo tiempo de desarrollo.	C#	JavaScript,Html,XML	MySQL	.NET	ISS	1 Meses	0	JQuery
1277	8	1	Publica	Educación	f	1 Meses	2017-10-19	Modalidad pasantia.\r\n\r\nAdministrador de origenes ODBC\r\nSegun cronograma de actividades duracion de proyecto 6 Meses\r\n\r\nValida tiempo de uso desde lanzamiento y fecha de ultima actualización\r\nNo especifica metodologia de desarrollo	C#	Html	PostgreSQL	.NET	ISS	6 Meses	0	No Especificado
...
1320	5	1	Privada	Financiero	f	1 Meses	2017-10-09	Que sector pertenece las constructoras?\r\nMirar bien la eleccion de tecnologias que se usan, en este caso parece que se desarrollo el producto sin tener en cuenta la disponibilidad de esas tecnologias en la empresa donde se implemetaria el sistema ? 	C#	JavaScript,Html,CSS	SQL Server	.NET	ISS	1 Meses	0	JQuery
